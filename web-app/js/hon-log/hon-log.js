...
(function($) {
    HonLog = {
            ...
            $('.bulk-load-form').submit(
                    function(e) {
                        ...
                        iframe.show().load(
                                ...
                                }).css('background', 'url(../images/spinner.gif) no-repeat center center').attr('src',
                                $(this).attr('ACTION') + '?' + $(this).serialize() + '&doAction=true');
        ...
        onPageLoad : function() {
            ...
            var icons = [ "pastel-24 pastel-24-page", "pastel-24 pastel-24-calculator",
                    "pastel-24 pastel-24-page-information", "pastel-24 pastel-24-page-suggestions" ];
